...
mod test_complex_input {
    ...
    fn test_complex_input_hash_matches_hoon() {
        ...
        println!(
            "  Expected Seeds hash: {:016x?}",
            expected_seeds_hash.values
        );
