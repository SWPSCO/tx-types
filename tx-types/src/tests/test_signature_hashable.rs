    ...
    fn test_signature_hashable_matches_hoon() {
        ...
        let sig1 = SchnorrSignature {
            ...
            sig: Sig {
                values: T8 {
                    values: [
                        0xbbbb, 0xcccc, 0xdddd, 0xeeee, 0xffff, 0x1111, 0x2345, 0x6789,
                    ],
                },
            },
        };
        ...
        let sig2 = SchnorrSignature {
            ...
            sig: Sig {
                values: T8 {
                    values: [
                        0xcccc, 0xdddd, 0xeeee, 0xffff, 0x1111, 0x2222, 0x3456, 0x789a,
                    ],
                },
            },
        };
        ...
        let sig3 = SchnorrSignature {
            ...
            sig: Sig {
                values: T8 {
                    values: [
                        0xaaaa, 0xbbbb, 0xcccc, 0xdddd, 0xeeee, 0xffff, 0x1234, 0x5678,
                    ],
                },
            },
        };
        ...
        let expected_hashable = Hashable::cell(
            ...
            Hashable::cell(Hashable::Hash(root_hash), Hashable::leaf(root_sig_bytes)),
            // Subtrees
            Hashable::cell(
                // Left subtree
                Hashable::cell(
                    // Left node: [hash, signature_data]
                    Hashable::cell(Hashable::Hash(left_hash), Hashable::leaf(left_sig_bytes)),
                ...
                Hashable::cell(
                    ...
                    Hashable::cell(Hashable::Hash(right_hash), Hashable::leaf(right_sig_bytes)),
        ...
        println!(
            "Expected hash from manually constructed hashable: {:016x?}",
            expected_hash_from_hashable.values
        );

        // The expected final hash from Hoon
        let expected_final_hash = Hash {
            values: [
        ...
        println!(
            "Expected final hash from Hoon: {:016x?}",
            expected_final_hash.values
        );
