...
use crate::transaction_types::{to_hashable_timelock_intent, Coins, Hash, Inputs, TimelockRange};
...
pub fn compute_tx_id(inputs: &Inputs, timelock_range: &TimelockRange, total_fees: Coins) -> Hash {
    ...
    let hashable = Hashable::triple(
        ...
        inputs
            .p
            .to_hashable(|nname| nname.to_hashable(), |input| input.to_hashable()),
...
mod tests {
    ...
    fn test_compute_tx_id() {
        ...
        use crate::transaction_types::{
            Coins, Input, Lock, NName, NNote, NNoteHead, PageNumber, Seeds, Source, Spend,
