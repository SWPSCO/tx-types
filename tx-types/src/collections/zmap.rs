    ...
    V: Clone + Debug,
{
    ...
    fn get_recursive<'a>(node: &'a Option<Box<Node<K, V>>>, key: &K) -> Option<&'a V> {
        match node {
            None => None,
            Some(n) => match Self::gor_tip(key, &n.key) {
        ...
        G: Fn(&V) -> crate::hashing::hashable::Hashable + Copy,
    {
        ...
        let node_pair = Hashable::cell(key_fn(&node.key), val_fn(&node.value));
...
mod tests {
    ...
    impl NounEncode for TestNName {
        fn to_noun<A: nockvm::noun::NounAllocator>(&self, alloc: &mut A) -> nockvm::noun::Noun {
            ...
            let atoms: Vec<nockvm::noun::Noun> = self
                .0
                .iter()
    ...
    fn test_ordering_consistency() {
        ...
        assert_eq!(
            items1, items2,
            "Order should be deterministic regardless of insertion order"
        );
    }
    ...
    fn test_hoon_zmap_single_pair() {
        use crate::transaction_types::{Hash, NName};
    ...
    fn test_zmap_to_hashable_matches_hoon() {
        ...
        use crate::hashing::{hash_hashable, Hashable};
                                ...
                                sig_map.put(
                                    ...
                                    SchnorrSignature {
                                        chal: Chal {
                                            values: T8 {
                                                values: [
                                                    0xed8e0dce, 0x8de80a50, 0xa530e89a, 0xb5f6de86,
                                                    0xac93a487, 0x703ef219, 0x9d543009, 0x6d48caea,
                                                ],
                                            },
                                        },
                                        sig: Sig {
                                            values: T8 {
                                                values: [
                                                    0xfe2ed679, 0x6c840083, 0x161b6cb7, 0xd8c6a1b3,
                                                    0x997b779f, 0xa11b4eca, 0xc828e5f4, 0x6a8ab03e,
                                                ],
                                            },
                                        },
                                    },
                                ...
                                sig_map.put(
                                    ...
                                    SchnorrSignature {
                                        chal: Chal {
                                            values: T8 {
                                                values: [
                                                    0xb7c4525c, 0x938699f, 0x3d3f03f6, 0x6d24039a,
                                                    0xc2d48aac, 0x66d99059, 0xa1bea1c2, 0x6c828ebf,
                                                ],
                                            },
                                        },
                                        sig: Sig {
                                            values: T8 {
                                                values: [
                                                    0xc1c516e0, 0x7e84b1b6, 0x61157822, 0xbc637e35,
                                                    0xe5d64131, 0x1e63e6a8, 0x5d1982c3, 0x72fe44f6,
                                                ],
                                            },
                                        },
                                    },
                                ...
                                sig_map.put(
                                    ...
                                    SchnorrSignature {
                                        chal: Chal {
                                            values: T8 {
                                                values: [
                                                    0xb3225a03, 0x13e43780, 0x1c657d61, 0x9f966f7c,
                                                    0xbb3b1bdf, 0xe64fb525, 0x6c3f653f, 0x18da2323,
                                                ],
                                            },
                                        },
                                        sig: Sig {
                                            values: T8 {
                                                values: [
                                                    0x901254d4, 0x6b39c687, 0x3e64dee2, 0x5df7769d,
                                                    0x9ed18fae, 0x79134f5c, 0xa42462e7, 0x70c98005,
                                                ],
                                            },
                                        },
                                    },
                                ...
                                sig_map.put(
                                    ...
                                    SchnorrSignature {
                                        chal: Chal {
                                            values: T8 {
                                                values: [
                                                    0xc0f45641, 0x8768c321, 0x535bc5e, 0x6a3b710e,
                                                    0xf3b64aba, 0xe15719b0, 0x910e8619, 0xb4a4a1a,
                                                ],
                                            },
                                        },
                                        sig: Sig {
                                            values: T8 {
                                                values: [
                                                    0xa08ebca0, 0xe8558d2c, 0xe4c079b5, 0x255b479,
                                                    0xb6d4ab38, 0x1b087c8d, 0x727d690f, 0x380b1a8e,
                                                ],
                                            },
                                        },
                                    },
                                ...
                                sig_map.put(
                                    ...
                                    SchnorrSignature {
                                        chal: Chal {
                                            values: T8 {
                                                values: [
                                                    0x8e217586, 0x9b0a33d0, 0xd14092e9, 0x468672e8,
                                                    0x2c8acc2f, 0xa778f63e, 0x6ca8c00d, 0x7a13c4,
                                                ],
                                            },
                                        },
                                        sig: Sig {
                                            values: T8 {
                                                values: [
                                                    0x96f85781, 0x52e46334, 0x109d591a, 0xbd111056,
                                                    0xe936877d, 0x7e182752, 0x4f64b938, 0x4d8a5364,
                                                ],
                                            },
                                        },
                                    },
        ...
        // Convert to hashable
        let hashable = zmap.to_hashable(|k| k.to_hashable(), |v| v.to_hashable());
            ...
            match h {
                ...
                Hashable::Cell(left, right) => {
                    ...
                    result.push_str(&format!(
                        "{}  p=\n{}\n",
                        spaces,
                        print_hashable_structure(left, indent + 2)
                    ));
                    result.push_str(&format!(
                        "{}  q=\n{}\n",
                        spaces,
                        print_hashable_structure(right, indent + 2)
                    ));
        ...
        assert_eq!(
            zmap.wyt(),
            5,
            "ZMap should contain 5 entries matching Hoon generator"
        );
        ...
        assert!(
            contains_hash(&hashable, &first_key_hash),
            "Structure should contain first key hash"
        );
        assert!(
            contains_hash(&hashable, &key2_input1),
            "Structure should contain key2 for input1"
        );
        assert!(
            contains_hash(&hashable, &key2_input2),
            "Structure should contain key2 for input2"
        );
        assert!(
            contains_hash(&hashable, &key2_input3),
            "Structure should contain key2 for input3"
        );
        assert!(
            contains_hash(&hashable, &key2_input4),
            "Structure should contain key2 for input4"
        );
        assert!(
            contains_hash(&hashable, &key2_input5),
            "Structure should contain key2 for input5"
        );
        ...
        let empty_hashable =
            empty_zmap.to_hashable(|k: &NName| k.to_hashable(), |v: &Input| v.to_hashable());
        ...
        match empty_hashable {
            Hashable::Leaf(data) => {
                ...
                assert_eq!(
                    data, expected,
                    "Empty ZMap should produce Leaf with jammed 0"
                );
